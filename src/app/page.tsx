...
export default function Home() {
  ...
  // Exibe loader enquanto valida autenticação
  if (loading)
    return (
  ...
  // Agora o ProtectedRoute redireciona para /auth em vez de usar login() diretamente
  return (
    <ProtectedRoute>
      <div className='grid grid-rows-[60px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]'>
        ...
        <main className='flex flex-col gap-[32px] row-start-2 items-center sm:items-start'>
          ...
          <div className='flex flex-col items-center gap-4 mt-6'>
            <span className='text-base font-semibold'>Usuário logado:</span>
            ...
            <div className='mt-4 flex flex-col gap-4 items-center'>
              ...
              <a
                ...
                Painel de Múltiplos Atendimentos
              </a>
            </div>
          </div>
